...
class BootOpsHttpTest {
    ...
    void bootOpsHttpIncludesRuntimeComponentsPassedByServerMain() throws Exception {
        ...
        ClusterEventSubscriptionManager eventSubscriptions =
        ...
        try (OpsHttpServer server = BootOpsHttp.start(
                config,
                local,
                actors,
                directory,
                gateway,
                transport,
                new ClusterNode(new InMemoryServiceRegistry(), local, directory),
                List.of(configCache),
                List.of(configRecovery),
                List.of(eventSubscriptions)
        )) {
